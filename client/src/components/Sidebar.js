...
import { MdMenu, MdManageAccounts, MdAnalytics, MdMonitor, MdEdit, MdHome } from "react-icons/md";
...
const Sidebar = () => {
  return (
    ...
    style={{backgroundColor: '#A47CA6', width: '15vw', height: '100vh', borderRadius: '10px' }}>
            ...
            <Link  to='/dashboard/home' className='text-decoration-none'><p className='text-light fs-5'><MdHome className='me-2'/>Home</p></Link>
